...
export class ArrayService {
    ...
    this.02_helper.array.randomItemFromArray(months)
    */
    ...
    this.02_helper.array.unionUniqueArrayValues(arrayA, arrayB); // [1, 2, 3, 4, 5, 6]
    */
    ...
    const arrayB = [2, 3, 2];
    this.02_helper.array.intersectionUniqueInArrays(arrayA, arrayB); // [2, 3]
    */
    ...
    this.02_helper.array.differenceUniqueInArrays(arrayA, arrayB); // [1, 4, 5, 7, 8]
    */
    ...
    const arrayA = [1, 2, 3, 4, 5, 5];
    const arrayB = [2, 3, 7, 7, 8];
    this.02_helper.array.differenceArrayFromAnother(arrayA, arrayB); // [1, 4, 5]
